...
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>, find whether N can be expressed as sum of two or more consecutive positive numbers. </span></p>
